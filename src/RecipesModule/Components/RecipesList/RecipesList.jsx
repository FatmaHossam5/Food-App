...
getAllRecipes(1);
       ...
       <Modal.Body>
        ...
        <i className="fa-regular fa-circle-xmark text-danger "></i>
          ...
          <div className="delete-btn text-end">
            <button onClick={deleteRecipe} className='text-danger border-danger rounded-2 bg-white'>Delete This Item </button>
          </div>
        </div>
  ...
  <tr >
    ...
    <td>{recipe.name}</td>
    <td>{recipe.imagePath?(<img src={`https://upskilling-egypt.com:443`+recipe.imagePath}/>):(<img className='img-fluid'src={avatar}/>)}</td>
...
<td>
  <i onClick={()=>showUpdateModal(recipe)} className='fa fa-edit text-warning fa-2x mx-2'></i>
  <i onClick={()=>showDeleteRecipe(recipe.id)} className='fa fa-trash text-danger fa-2x mx-2'></i>
